...
Run detail pages expose post-run analysis/material preparation actions: classify run, run review checks, prepare review, controlled findings submission, and controlled arbitration submission. They do not run reviewer agents, approve/reject, apply, accept, commit, run Codex, or run pipeline.
