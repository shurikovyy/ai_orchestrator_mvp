...
- no apply/accept/commit actions.
...
Run detail pages expose post-run analysis/material preparation actions: classify run, run review checks, prepare review, controlled findings submission, controlled arbitration submission, and explicit human review decision. They do not run reviewer agents, apply, accept, commit, run Codex, or run pipeline.
